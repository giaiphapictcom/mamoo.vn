...
function Admin_ProductDistributor_Xoa(pId, pPage) {
    ...
    $.ajax({
        ...
        data: { 'pId': pId },
        dataType: 'json',
        url: "/Admin/SanPhamNhaPhanPhoiThucHienXoa",
        timeout: 60000,
        success: function (data) {
            if (data.code == 1) {
                window.location = "/Admin/SanPhamNhaPhanPhoi?pPage=" + pPage + "";
            }
            else {
...
function Admin_ProductDistributor_ThucHienLuuMoi() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "/Admin/SanPhamNhaPhanPhoiThucHienThemMoi/",
        timeout: 60000,
        success: function (data) {
            $("#wait").css("display", "none");
            if (data.code == 1) {
...
function Admin_ProductDistributor_ThucHienLuuSua() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "/Admin/SanPhamNhaPhanPhoiThucHienSua/",
        timeout: 60000,
        success: function (data) {
            $("#wait").css("display", "none");
            if (data.code == 1) {
...
function Admin_ProductDistributor_ComeHome() {
    ...
    window.location = "/Admin/SanPhamNhaPhanPhoi";
}

function Admin_ProductDistributor_ComeSua(pId) {

    window.location = "/Admin/SanPhamNhaPhanPhoiSua?pId=" + pId + "";
}
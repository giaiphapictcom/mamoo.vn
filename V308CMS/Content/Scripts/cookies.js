...
/*Ham tien ich giup ta tao Time het han cua Coookies*/
function createExpireTime(timestamp) {
    var date = new Date();
    timestamp = timestamp * 1000;
    date.setTime(timestamp);
...
/*Tao Cookies moi*/ /* cung dugn de Thay doi gia tri cua Cookies*/

function CreateCookies(name, val, exp) {

    var date = createExpireTime(exp);
    $.cookie(name, val, date);
}

...
function Admin_Support_Xoa(pId, pPage) {
    ...
    $.ajax({
        ...
        data: { 'pId': pId },
        dataType: 'json',
        url: "/Admin/HoTroThucHienXoa",
        timeout: 60000,
        success: function (data) {
            if (data.code == 1) {
                window.location = "/Admin/HoTro?pPage=" + pPage + "";
            }
            else {
...
function Admin_Support_ThucHienLuuMoi() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "/Admin/HoTroThucHienThemMoi/",
        timeout: 60000,
        success: function (data) {
            $("#wait").css("display", "none");
            if (data.code == 1) {
...
function Admin_Support_ComeHome() {
    ...
    window.location = "/Admin/HoTro";
}

function Admin_Support_ComeSua(pId) {

    window.location = "/Admin/HoTroSua?pId=" + pId + "";
}
...
function Admin_SupportType_Xoa(pId, pPage) {
    ...
    $.ajax({
        ...
        data: { 'pId': pId },
        dataType: 'json',
        url: "/Admin/HoTroLoaiHoTroThucHienXoa",
        timeout: 60000,
        success: function (data) {
            if (data.code == 1) {
                window.location = "/Admin/HoTroLoaiHoTro?pPage=" + pPage + "";
            }
            else {
...
function Admin_SupportType_ThucHienLuuMoi() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "/Admin/HoTroLoaiHoTroThucHienThemMoi/",
        timeout: 60000,
        success: function (data) {
            $("#wait").css("display", "none");
            if (data.code == 1) {
...
function Admin_SupportType_ThucHienLuuSua() {
    ...
    $.ajax({
        ...
        dataType: 'json',
        url: "/Admin/HoTroLoaiHoTroThucHienSua/",
        timeout: 60000,
        success: function (data) {
            $("#wait").css("display", "none");
            if (data.code == 1) {
...
function Admin_SupportType_ComeHome() {
    ...
    window.location = "/Admin/HoTroLoaiHoTro";
}

function Admin_SupportType_ComeSua(pId) {

    window.location = "/Admin/HoTroLoaiHoTroSua?pId=" + pId + "";
}